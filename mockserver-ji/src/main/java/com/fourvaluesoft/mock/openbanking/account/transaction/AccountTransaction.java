...
public class AccountTransaction {
    ...
    private List<AccountTransactionResList> resList;
    ...
    public Integer getBankTranDate() {
        return bankTranDate;
    }

    public void setBankTranDate(Integer bankTranDate) {
    ...
    public Integer getPageRecordCnt() {
        return pageRecordCnt;
    }

    public void setPageRecordCnt(Integer pageRecordCnt) {
    ...
    public List<AccountTransactionResList> getResList() {
        return resList;
    }

    public void setResList(List<AccountTransactionResList> resList) {
